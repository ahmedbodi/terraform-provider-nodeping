...
func TestDataSourceMetadata(t *testing.T) {
	...
	NewContactDataSource().Metadata(context.Background(), fwdatasource.MetadataRequest{ProviderTypeName: "nodeping"}, resp)
...
func TestDataSourceSchemaIsValid(t *testing.T) {
	...
	NewContactDataSource().Schema(ctx, fwdatasource.SchemaRequest{}, resp)
