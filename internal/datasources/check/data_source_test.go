...
func TestDataSourceMetadata(t *testing.T) {
	...
	NewCheckDataSource().Metadata(context.Background(), fwdatasource.MetadataRequest{ProviderTypeName: "nodeping"}, resp)
...
func TestDataSourceSchemaIsValid(t *testing.T) {
	...
	NewCheckDataSource().Schema(ctx, fwdatasource.SchemaRequest{}, resp)
